Vagrant.configure("2") do |config|
    ...
    config.vm.define :mgmt do |mgmt_config|
      ...
      mgmt_config.vm.box_url = "file:///cygwin64/home/boxes/ubuntu-mesos/trusty64-with-ansible" 
    ...
    config.vm.define :"mesos-master" do |mesos_config|
      ...
      mesos_config.vm.box_url = "file:///cygwin64/home/boxes/ubuntu-mesos/ubuntu-mesos-master"
    ...
    config.vm.define :"mesos-slave" do |slave_config|
      ...
      slave_config.vm.box_url = "file:///cygwin64/home/boxes/ubuntu-mesos/ubuntu-mesos-slave"
